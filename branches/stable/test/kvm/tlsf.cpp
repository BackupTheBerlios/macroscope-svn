...
/**************     Helping functions    **************************/
/******************************************************************/
static __inline__ void set_bit(intptr_t nr, u32_t * addr);
static __inline__ void clear_bit(intptr_t nr, u32_t * addr);
static __inline__ intptr_t ls_bit(intptr_t x);
static __inline__ intptr_t ms_bit(intptr_t x);
static __inline__ void MAPPING_SEARCH(size_t * _r, intptr_t *_fl, intptr_t *_sl);
static __inline__ void MAPPING_INSERT(size_t _r, intptr_t *_fl, intptr_t *_sl);
static __inline__ bhdr_t *FIND_SUITABLE_BLOCK(tlsf_t * _tlsf, intptr_t *_fl, intptr_t *_sl);
static __inline__ bhdr_t *process_area(void *area, size_t size);
#if USE_SBRK || USE_MMAP
static __inline__ void *get_new_area(size_t * size);
#endif

static const intptr_t table[] = {
...
static __inline__ intptr_t ls_bit(intptr_t i)
{
    uintptr_t a;
    uintptr_t x = i & -i;
...
static __inline__ intptr_t ms_bit(intptr_t i)
{
    uintptr_t a;
